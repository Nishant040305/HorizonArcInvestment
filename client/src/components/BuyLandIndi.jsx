  ...
  return (
    <div className="rounded-3xl buy-cart bg-white">
      ...
      <div className="buy-cart-info">
        ...
        <div className="buy-cart-info-amount"><div className="total_amount">{props.Price?`Rs. ${numTowords(Number(props.Price))}`:"Rs. 40Lakhs"}</div></div>
        <div className='buy-cart-info-area'><div className="total_area">{props.amount?`${props.amount}${props.unit}`:"1250sqft"}</div><div></div>Plot Area</div>
